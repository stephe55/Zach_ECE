...
int main(int argc, char * * argv)
{
	...
	my_strcpy(buffer2, "Zach");
	printf("buffer2 = %s\n\n\n",buffer2);
	my_strcat(buffer2, " Stephens");
	my_strcat(buffer2, " was");
	my_strcat(buffer2, " here");
	printf("buffer and stephens = %s \n \n\n",buffer2);
	...
	int len1;
	len1=my_atoi("           -0453 dkfhjskjdhf"); // 0
	printf("len1 = %d\n", len1);
	len1=my_atoi("-12"); // -12
	printf("len1 = %d\n", len1);
	len1=my_atoi("15th of March would be the ides."); // 15
	printf("len1 = %d\n", len1);
	len1=my_atoi("4 months to Summer."); // 4
	printf("len1 = %d\n", len1);
	len1=my_atoi("\n\f\t\v\r 6 white space characters handled correctly."); // 6
	printf("len1 = %d\n", len1);
	len1=my_atoi("garbage should yield 0"); // 0
	printf("len1 = %d\n", len1);
    //---------------------------------------------------------------
